...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A premium property listing and brokerage platform built for real estate agents and luxury dealers. Features interactive search, buy/rent filters, and direct broker consultation flows.",
    impact: "",
    technologies: ["React", "Next.js", "Tailwind CSS", "Vercel"],
    role: "Full Stack Developer",
    year: "2026",
