...
export function Services() {
  return (
    <section
      id="services"
      className="section-pad scroll-mt-24 border-t border-border bg-surface"
      ...
      <div className="page-shell">
        <Reveal className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <p className="max-w-sm text-muted">
            A focused set of ways to plan, build, and refine a website — from structure to the last interaction.
          </p>
        </Reveal>
        ...
        <ul className="mt-12 border-b border-border md:mt-16">
          {services.map((service, index) => (
            ...
            <Reveal delay={index * 0.04}>
              <article className="group grid gap-3 border-t border-border py-7 transition-colors duration-300 md:grid-cols-12 md:items-baseline md:gap-6 md:py-9">
