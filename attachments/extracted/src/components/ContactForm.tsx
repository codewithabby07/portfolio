...
function validate(values: Fields): Errors {
  ...
  if (values.message.trim().length < 10) {
    errors.message = "Please write a short project note (at least 10 characters).";
  }
  return errors;
}
    ...
    >
      ...
      <div className="page-shell relative grid items-center gap-12 lg:grid-cols-12">
        <Reveal className="text-white lg:col-span-6">
          ...
          <h2
            id="contact-heading"
            className="display mt-4 text-6xl md:text-8xl"
          >
            {site.contact.title.toUpperCase()}
          </h2>
          <p className="mt-6 max-w-md text-white/75">
            Tell Abby about the website, product, or experience you want to build. The form is ready on the frontend — email delivery can be connected without changing this layout.
          </p>
        </Reveal>

        <Reveal className="lg:col-span-6" delay={0.1}>
          <div className="overflow-hidden bg-surface shadow-2xl">
            <div className="bg-gradient-to-r from-dark to-accent px-6 py-5 md:px-8">
            ...
            <form onSubmit={onSubmit} noValidate>
              ...
              <button
                ...
                className={cn(
                  "mt-2 inline-flex w-full items-center justify-center bg-dark px-6 py-4 text-[12px] font-semibold tracking-[0.18em] text-white uppercase transition-colors duration-300",
                  "hover:bg-accent",
                  "disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-dark",
...
function Field({
  ...
  return (
    <div className="mb-4">
      <label htmlFor={id} className="mb-2 block text-[12px] font-medium tracking-wide text-dark">
        {label}
