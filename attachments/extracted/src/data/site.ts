/**
 * Edit this file to update brand, copy, portrait, socials, and SEO.
...
export const site = {
  ...
  portrait: {
    ...
    alt: "Portrait of Abby. Replace this file at /images/portrait.jpg to update the photograph without changing the layout.",
    width: 1024,
    height: 1024,
  },
  nav: [
    ...
    { label: "Work", href: "#work", id: "work", count: "04" },
    { label: "Services", href: "#services", id: "services", count: "06" },
